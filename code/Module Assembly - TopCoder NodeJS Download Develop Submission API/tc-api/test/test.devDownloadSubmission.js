...
describe('Download Submission API', function () {
    ...
    */
    ...
    /**
     * Test /v2/develop/download/:uploadId but uploadId is negative
     * should return 400 error
     */
    it('should return 400 error when upload id is negative', function (done) {
    ...
    /**
     * Test /v2/develop/download/:uploadId but uploadId is 0
     * should return 400 error
     */
    it('should return 400 error when upload id is 0', function (done) {
        request(API_ENDPOINT)
    ...
    /**
     * Test /v2/develop/download/:uploadId but uploadId is larger than max integer
     * should return 400 error
     */
    it('should return 400 error when upload id is larger than max integer', function (done) {
        request(API_ENDPOINT)
    ...
    /**
     * Test /v2/develop/download/:uploadId but user is not logged-in and it is not thurgood request
    ...
    /**
     * Test /v2/develop/download/:uploadId and user is not logged-in but it is a thurgood request
    ...
    /**
     * Test /v2/develop/download/:uploadId when upload does not exist
    ...
    /**
     * Test /v2/develop/download/:uploadId when project is not a develop project
     * should return 400 error
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when project is a marathon match
     * should return 400 error
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when upload is not a submission
     * should return 400 error
     */
    it('should return 400 error when upload not a submission', function (done) {
        var req = getRequest('/v2/develop/download/88883', user124764, 400, /json/);
        req.end(function (err, resp) {
            if (err) {
                done(err);
                return;
            }
            assert.equal(resp.body.error.details, "This upload is not a submission.");
            done();
        });
    });

    /*
     * Test /v2/develop/download/:uploadId when upload is a submission but is deleted
     * should return 400 error
     */
    it('should return 404 error when upload deleted', function (done) {
        ...
        req.end(function (err, resp) {
            ...
            assert.equal(resp.body.error.details, "This upload has been deleted.");
            done();
        });
    });

    /**
     * Test /v2/develop/download/:uploadId when user is the copilot regardless of the phase
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is the submitter regardless of the phase
     * Here the contest is in submission phase, so only manager level users and the submitter can download the submission
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is the screener but the screening phase is not yet open
     * should return 403
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is the screener and current phase is screening
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is the reviewer but the review phase is not yet open
     * should return 403
     * should log the failed download attempt to the project_download_audit table
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is the reviewer and current phase is review
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user tries to submit someone else's submission but review process not over
     * should return 403
     * should log the failed download attempt to the project_download_audit table
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user failed screening and tries do download someone else's submission
     * should return 403
     * should log the failed download attempt to the project_download_audit table
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user tries to download another user's submission.
    ...
    /**
     * Test /v2/develop/download/:uploadId when iterative reviewer tried to download a submission already reviewed by him.
    ...
    /**
     * Test /v2/develop/download/:uploadId when iterative reviewer tries to download next in queue submission.
     * should return 200 as method should succeed
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when iterative reviewer tries to download submission not yet reviewed and not next in queue
     * should return 403
     * should log the failed download attempt to the project_download_audit table
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId for success when zip format
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId for success when tar.gz format
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId for success when doc format
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId for success when 7z format
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId for success when jar format
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId for success when docx format
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is the checkpoint reviewer and project is in checkpoint screening and upload is checkpoint
     * should return 403
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is checkpoint screener and project is in checkpoint screening and upload is checkpoint
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is checkpoint reviewer and project is in checkpoint review and upload is checkpoint
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is the post-mortem reviewer and upload is checkpoint (regardless of phase)
     * should return 200
     */
    ...
    /*
     * Test /v2/develop/download/:uploadId when upload is deleted but user has role to view all submissions
     * should return 200
     */
    ...
    /**
     * Test /v2/develop/download/:uploadId when user is normal reviewer and project is in checkpoint review and upload is checkpoint
     * should return 403
     */
