...
{
    /// <summary>
    /// <para>This exception signals issues with preprocessing of a layouting request.</para>
    /// </summary>
    /// <threadsafety>
    ...
    [Serializable]
    public class LayoutPreProcessingException : LayoutException
    {

        /// <summary>
        /// <para>Creates a new LayoutPreProcessingException instance</para>
        /// </summary>
        public LayoutPreProcessingException() : base()
        {
        }
        ...
        public LayoutPreProcessingException(String message) : base(message)
        {
        }
        ...
        public LayoutPreProcessingException(String message, Exception cause) : base(message, cause)
        {
        }
        ...
        protected LayoutPreProcessingException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
