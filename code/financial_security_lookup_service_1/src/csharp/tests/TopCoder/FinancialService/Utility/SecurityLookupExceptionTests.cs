...
{
    /// <summary>
    /// Unit tests for the SecurityLookupException class.
    /// </summary>
    /// <author>TCSDEVELOPER</author>
    /// <version>1.0</version>
    /// <copyright>Copyright (c) 2007, TopCoder, Inc. All rights reserved.</copyright>
    [TestFixture]
    public class SecurityLookupExceptionTests
    {
        /// <summary>
        ...
        /// <summary>
        /// <p>Test SecurityLookupException().</p>
        ///
        ...
        {
            Assert.IsTrue(new SecurityLookupException() is FinancialSecurityException,
                "Wrong type of SecurityLookupException");
            Assert.IsTrue(new SecurityLookupException() is SelfDocumentingException,
                "Wrong type of SecurityLookupException");
        }

        /// <summary>
        /// <p>Test SecurityLookupException(string), by passing a null reference.</p>
        ///
        ...
        {
            new SecurityLookupException(null);
        }

        /// <summary>
        /// <p>Test SecurityLookupException(string),
        ...
        {
            Exception e = new SecurityLookupException(message);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
        }

        /// <summary>
        /// <p>Test SecurityLookupException(string, Exception),
        ...
        {
            new SecurityLookupException(null, null);
        }
        ...
        {
            Exception e = new SecurityLookupException(message, null);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
        }
        ...
        {
            Exception e = new SecurityLookupException(null, cause);
        ...
        {
            Exception e = new SecurityLookupException(message, cause);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
            Assert.AreEqual(cause, e.InnerException, "e.InnerException should be equal to cause.");
        }

        /// <summary>
        /// <p>Test SecurityLookupException(SerializationInfo, StreamingContext).</p>
        ///
        ...
        public void TestCtorInfoContext()
        {
            ...
            using (Stream stream = new MemoryStream())
            {
                ...
                SecurityLookupException serial =
                    new SecurityLookupException(message, cause);
                BinaryFormatter formatter = new BinaryFormatter();
                formatter.Serialize(stream, serial);

                // Deserialize the instance.
                stream.Seek(0, SeekOrigin.Begin);
                SecurityLookupException deserial =
                    formatter.Deserialize(stream) as SecurityLookupException;
