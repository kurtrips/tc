...
{
    /// <summary>
    /// Unit tests for the InvalidSecurityIdFormatException class.
    /// </summary>
    /// <author>TCSDEVELOPER</author>
    /// <version>1.0</version>
    /// <copyright>Copyright (c) 2007, TopCoder, Inc. All rights reserved.</copyright>
    [TestFixture]
    public class InvalidSecurityIdFormatExceptionTests
    {
        /// <summary>
        ...
        /// <summary>
        /// <p>Test InvalidSecurityIdFormatException().</p>
        ///
        ...
        {
            Assert.IsTrue(new InvalidSecurityIdFormatException() is SecurityIdParsingException,
                "Wrong type of InvalidSecurityIdFormatException");
        ...
        /// <summary>
        /// <p>Test InvalidSecurityIdFormatException(string), by passing a null reference.</p>
        ///
        ...
        {
            new InvalidSecurityIdFormatException(null);
        }

        /// <summary>
        /// <p>Test InvalidSecurityIdFormatException(string),
        ...
        {
            Exception e = new InvalidSecurityIdFormatException(message);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
        }

        /// <summary>
        /// <p>Test InvalidSecurityIdFormatException(string, Exception),
        ...
        {
            new InvalidSecurityIdFormatException(null, null);
        }
        ...
        {
            Exception e = new InvalidSecurityIdFormatException(null, cause);
        ...
        /// <summary>
        /// <p>Test InvalidSecurityIdFormatException(SerializationInfo, StreamingContext).</p>
        ///
