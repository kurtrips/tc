...
{
    /// <summary>
    /// Unit tests for the InvalidSecurityIdTypeException class.
    /// </summary>
    /// <author>TCSDEVELOPER</author>
    /// <version>1.0</version>
    /// <copyright>Copyright (c) 2007, TopCoder, Inc. All rights reserved.</copyright>
    [TestFixture]
    public class InvalidSecurityIdTypeExceptionTests
    {
        /// <summary>
        ...
        /// <summary>
        /// <p>Test InvalidSecurityIdTypeException().</p>
        ///
        ...
        {
            Assert.IsTrue(new InvalidSecurityIdTypeException() is FinancialSecurityException,
                "Wrong type of InvalidSecurityIdTypeException");
            Assert.IsTrue(new InvalidSecurityIdTypeException() is SelfDocumentingException,
                "Wrong type of InvalidSecurityIdTypeException");
        }

        /// <summary>
        /// <p>Test InvalidSecurityIdTypeException(string), by passing a null reference.</p>
        ///
        ...
        {
            new InvalidSecurityIdTypeException(null);
        }

        /// <summary>
        /// <p>Test InvalidSecurityIdTypeException(string),
        ...
        {
            Exception e = new InvalidSecurityIdTypeException(message);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
        }

        /// <summary>
        /// <p>Test InvalidSecurityIdTypeException(string, Exception),
        ...
        {
            new InvalidSecurityIdTypeException(null, null);
        }
        ...
        {
            Exception e = new InvalidSecurityIdTypeException(message, null);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
        }
        ...
        {
            Exception e = new InvalidSecurityIdTypeException(null, cause);
        ...
        {
            Exception e = new InvalidSecurityIdTypeException(message, cause);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
            Assert.AreEqual(cause, e.InnerException, "e.InnerException should be equal to cause.");
        }

        /// <summary>
        /// <p>Test InvalidSecurityIdTypeException(SerializationInfo, StreamingContext).</p>
        ///
        ...
        public void TestCtorInfoContext()
        {
            ...
            using (Stream stream = new MemoryStream())
            {
                ...
                InvalidSecurityIdTypeException serial =
                    new InvalidSecurityIdTypeException(message, cause);
                BinaryFormatter formatter = new BinaryFormatter();
                formatter.Serialize(stream, serial);

                // Deserialize the instance.
                stream.Seek(0, SeekOrigin.Begin);
                InvalidSecurityIdTypeException deserial =
                    formatter.Deserialize(stream) as InvalidSecurityIdTypeException;
