...
{
    /// <summary>
    /// <para>Test <see cref="DatePatternInvalidDataException"/> class, unit test.</para>
    /// </summary>
    ///
    ...
    [TestFixture]
    public class DatePatternInvalidDataExceptionUnitTest
    {
        /// <summary>
        ...
        /// <summary>
        /// <para>Test DatePatternInvalidDataException().</para>
        /// <para>The type of the exception must be correct.</para>
        /// </summary>
        [Test]
        public void TestCtor()
        {
            Exception ex = new DatePatternInvalidDataException();
        ...
        /// <summary>
        /// <para>Test DatePatternInvalidDataException(string), by passing a null reference.</para>
        /// </summary>
        [Test]
        public void TestCtorMessage_Null()
        {
            new DatePatternInvalidDataException(null);
        }

        /// <summary>
        /// <para>Test DatePatternInvalidDataException(string),
        /// by passing an error message.</para>
        /// </summary>
        [Test]
        public void TestCtorMessage_Valid()
        {
            Exception e = new DatePatternInvalidDataException(message);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
        }

        /// <summary>
        /// <para>Test DatePatternInvalidDataException(string, Exception),
        /// by passing null references.</para>
        /// </summary>
        [Test]
        public void TestCtorMessageInner_Null3()
        {
            new DatePatternInvalidDataException(null, null);
        }
        ...
        {
            Exception e = new DatePatternInvalidDataException(message, null);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
        }
        ...
        {
            Exception e = new DatePatternInvalidDataException(null, cause);
        ...
        {
            Exception e = new DatePatternInvalidDataException(message, cause);
            Assert.AreEqual(message, e.Message, "e.Message should be equal to message.");
            Assert.AreEqual(cause, e.InnerException, "e.InnerException should be equal to cause.");
        }

        /// <summary>
        /// <para>Test DatePatternInvalidDataException(SerializationInfo, StreamingContext).</para>
        ///
        ...
        public void TestCtorInfoContext()
        {
            ...
            using (Stream stream = new MemoryStream())
            {
                ...
                DatePatternInvalidDataException serial =
                    new DatePatternInvalidDataException(message, cause);
                BinaryFormatter formatter = new BinaryFormatter();
                formatter.Serialize(stream, serial);

                // Deserialize the instance.
                stream.Seek(0, SeekOrigin.Begin);
                DatePatternInvalidDataException deserial =
                    formatter.Deserialize(stream) as DatePatternInvalidDataException;
