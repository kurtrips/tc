...
namespace HermesNS.TC.Services.ScheduleItem.Persistence
{
        ...
        HermesGenericNoteItem, HermesGenericNoteItemHistory>
    {
        ...
        private static HermesActivityType CreateHermesActivityType(IDataReader reader)
        {
            ...
            hermesActivityType.LastModifiedDate = Convert.ToDateTime(reader["act_typ_last_modified_dt"]);
        ...
        private static HermesActivityGroup CreateHermesActivityGroup(IDataReader reader)
        {
            ...
            hermesActivityGroup.LastModifiedDate = Convert.ToDateTime(reader["act_grp_last_modified_dt"]);
        ...
        private static HermesScheduleItemStatus CreateHermesScheduleItemStatus(IDataReader reader)
        {
            ...
            hermesScheduleItemStatus.LastModifiedDate = Convert.ToDateTime(reader["s_last_modified_dt"]);
        ...
        private static HermesScheduleItemRequestStatus CreateHermesScheduleItemRequestStatus(IDataReader reader)
        {
            ...
            hermesScheduleItemRequestStatus.LastModifiedDate = Convert.ToDateTime(reader["rs_last_modified_dt"]);
        ...
        private static HermesActivity CreateHermesActivity(IDataReader reader)
        {
            ...
            hermesActivity.DefaultStartTime =
                (Convert.ToDateTime(reader["default_start_time"]).Subtract(new DateTime(2001, 1, 1))).Seconds;
            hermesActivity.Abbreviation = reader["activity_abbr"] as string;
            hermesActivity.LastModifiedDate = (DateTime)reader["act_last_modified_dt"];
        ...
        private static HermesScheduleItem CreateHermesScheduleItem(IDataReader reader)
        {
            ...
            hermesScheduleItem.ExpirationDate = Convert.ToDateTime(reader["expire_dt"]);
            hermesScheduleItem.LastModifiedDate = Convert.ToDateTime(reader["last_modified_dt"]);
            ...
            hermesScheduleItem.WorkDate = Convert.ToDateTime(reader["work_dt"]);
