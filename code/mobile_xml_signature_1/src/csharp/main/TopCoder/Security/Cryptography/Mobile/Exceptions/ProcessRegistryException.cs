...
{
    /// <summary>
    /// <p>This exception class wraps up any exception that is thrown during the setup or extraction of keys
    /// from the Registry</p>
    ...
    public class ProcessRegistryException : ApplicationException
    {
        /// <summary>
        /// <p>Purpose: Constructs this exception without a message or inner exception.</p>
        /// </summary>
        public ProcessRegistryException() : base()
        {
        }
        ...
        public ProcessRegistryException(string message) : base(message)
        {
        }
        ...
        /// <param name="message">The exception message</param>
        public ProcessRegistryException(string message, Exception inner)
            : base(message, inner)
        {
        }
