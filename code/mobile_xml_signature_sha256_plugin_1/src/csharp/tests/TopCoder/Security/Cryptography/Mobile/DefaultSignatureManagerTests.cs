...
namespace TopCoder.Security.Cryptography.Mobile
{
    ...
    public class SignatureManagerTests
    {
        ...
        public void SetUp()
        {
            ...
            reference1 = new Reference("http://www.topcoder.com/tc", transformersList1, digester1, "http");
        ...
        public void TestVerifySignatureFailure1()
        {
            ...
            XmlNode sigValueNode = signed.SelectSingleNode("ds:SignatureValue", nsMgr);
            string signature = sigValueNode.InnerXml;

            //Tamper it.
            signature = signature.ToUpper();
            signed.SelectSingleNode("ds:SignatureValue", nsMgr).InnerXml = signature;
